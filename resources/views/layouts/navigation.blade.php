        ...
        <div class="flex flex-col justify-between content-between h-full divide-y">
            ...
            <div class="hidden sm:flex sm:items-center pb-20 pt-3">
                <x-dropdown align="left" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-neutral-500 bg-primary-50 hover:text-neutral-700 focus:outline-none transition">
