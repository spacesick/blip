    ...
    <div class="flex border border-neutral-200 rounded-md text-sm px-4 py-3 min-w-48">
        ...
        @if(!$balance)
            <div class="grow flex justify-end place-items-center">
                <div wire:click="fetchBalance" class="fill-neutral-500 p-2 align-center items-center rounded-md font-semibold text-xs text-gray-700 hover:bg-primary-200 focus:outline-none focus:bg-primary-200 transition">
