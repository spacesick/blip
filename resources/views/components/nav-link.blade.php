...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-accent-400 text-sm font-medium leading-5 text-primary-900 focus:outline-none focus:border-accent-700 transition duration-150 ease-in-out'
